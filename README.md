...
![Exemplo de estrutura de controle](estruturaExemplo.png)
![Exemplo de estrutura de controle](estruturaResposta.png)
...
![Exemplo de Funções e Modularidade](declaracaoExemplo.png)
![Exemplo de Funções e Modularidade](declaracaoResposta.png)

# 
# 

![Exemplo de Funções e Modularidade](escoposExemplo.png)
![Exemplo de Funções e Modularidade](escoposRespostas.png)
...
![Exemplo de Funções e Modularidade](retornandoValoresExemplo.png)
![Exemplo de Funções e Modularidade](retornandoValoresResposta.png)
...
![Exemplo de Manipulação do DOM](manipulacaoDOMhtml.png)
![Exemplo de Manipulação do DOM](retornandoValoresExemplo.png)
...
![Exemplo de Aplicações Práticas](formsExemplo.png)
![Exemplo de Aplicações Práticas](interacaoWeb.png)
![Exemplo de Aplicações Práticas](calculadoraExemplo.png)
